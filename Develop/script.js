...
var displayTime = document.querySelector('#todaysDate');
...
$('#9am-row .description').val(
  localStorage.getItem('9am-row')
);

// 10am
$('#10am-row .description').val(
  localStorage.getItem('10am-row')
);

// 11am
$('#11am-row .description').val(
  localStorage.getItem('11am-row')
);

// 12pm
$('#12pm-row .description').val(
  localStorage.getItem('12pm-row')
);

// 1pm
$('#1pm-row .description').val(
  localStorage.getItem('1pm-row')
);

// 2pm
$('#2pm-row .description').val(
  localStorage.getItem('2pm-row')
);

// 3pm
$('#3pm-row .description').val(
  localStorage.getItem('3pm-row')
);

// 4pm
$('#4pm-row .description').val(
  localStorage.getItem('4pm-row')
);

// 5pm
$('#5pm-row .description').val(
  localStorage.getItem('5pm-row')
);

console.log('H is for Hour');
